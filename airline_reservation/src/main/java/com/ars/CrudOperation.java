...
public static void boardingPass()
{
	...
	System.out.println(" Name: "+tDto.getPid().getName()+"\t\tNo of Passenger "
			+tDto.getNo_of_passenger());
	System.out.println("From: "+tDto.getId().getSource()+"\t\t"+tDto.getId().getDestination());
	System.out.println("Flight: "+tDto.getId().getFlight_id()+"\t\tDate: "+tDto.getId().getDate());
